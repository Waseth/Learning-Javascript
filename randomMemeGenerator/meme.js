...
function showMeme() {
  ...
  const outPutAreaOne = document.querySelector('.content');
  const img = document.createElement('img');
  img.src = randomMemeUrl;
  img.alt = 'meme image';
  outPutAreaOne.appendChild(img);
}
...
function showJoke() {
  ...
  const outPutAreaTwo = document.querySelector('.content');
  const joke = document.createElement('p');
  joke.textContent = randomJokeText;
  outPutAreaTwo.appendChild(joke);
...
function showQuote() {
  ...
  const outPutAreaThree = document.querySelector('.content');
  const quoteText = document.createElement('p');
  const authorName = document.createElement('p');
  quoteText.textContent = randomQuote.quote;
  authorName.textContent =  '- ' + randomQuote.author;

  outPutAreaThree.appendChild(quoteText);
  outPutAreaThree.appendChild(authorName);
...
function revealAnswers() {
  ...
  if (!answer) {
    alert("No riddle is currently shown!");
